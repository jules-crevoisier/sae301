...
export default function ContactHero() {
  return (
    <section className="relative pt-32 pb-16 bg-bouilly-cream overflow-hidden">
      {/* Fond DA */}
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
        ...
        >
          ...
          <p className="text-gray-600 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed font-light">
            Une question sur vos démarches, un signalement ou simplement envie d'échanger ? Nos services sont là pour vous répondre.
          </p>
        </motion.div>
      </div>
    </section>
